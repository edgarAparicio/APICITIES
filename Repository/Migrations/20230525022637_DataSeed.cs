        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 2, 1, "A 102-story skycraper located in MidTown Manhttan.", "Empire State Building" },
                    { 3, 2, "A Gothic style cathedral, conceived by architects Jan.", "Cathedral" },
                    { 4, 3, "The most visited urban park in the United States.", "Urban Park" },
                    { 5, 3, "The most visited paso in the United States.", "The Texas Paso" },
                    { 6, 3, "A wrought iron lattice tower on the Champ de Mars.", "Eiffel tower" },
                    { 7, 2, "The world's largest museum'.", "The Louvre" }
                });
        }
